...
| A magnet on a printed TPU flexure over a 3-axis Hall **reads a keypress at ~430 LSB** (200× the sensor noise); the five directions sit **≥78° apart**, 0 classifier errors in 10⁵ | the read-out §8.15g deferred, now modelled (`manufacture/readout.py`). ⚠ the physical **mount** that holds the magnet + Hall is being **redesigned** under a finger-entry-route constraint — the first attempt was built without modelling how the finger enters the cup, and is withdrawn (§8.15l ppp) |
