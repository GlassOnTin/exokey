...
| A magnet on a printed TPU flexure over a 3-axis Hall **reads a keypress at ~430 LSB** (200× the sensor noise); the five directions sit **≥78° apart**, 0 classifier errors in 10⁵ | the read-out §8.15g deferred, now modelled — the wells become a **watertight, one-piece** print with the sensor seats and wire grooves carved in (**39 g** solid, +13.5 g for the sensors). ⚠ the tightest pair (middle–ring) still needs cluster packing (§8.15l) |
